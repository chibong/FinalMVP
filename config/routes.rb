MVP::Application.routes.draw do
  ...
  # CREATE
  get 'users/:user_id/feedbacks/new', controller: 'feedbacks', action: 'new', as: 'new_feedback'
  post 'users/:user_id/feedbacks', controller: 'feedbacks', action: 'create'

  # READ
  get 'users/:user_id/feedbacks', controller: 'feedbacks', action: 'index', as: 'feedbacks'
  get 'users/:user_id/feedbacks/:id', controller: 'feedbacks', action: 'show', as: 'feedback'

  # UPDATE
  get 'users/:user_id/feedbacks/:id/edit', controller: 'feedbacks', action: 'edit', as: 'edit_feedback'
  put 'users/:user_id/feedbacks/:id', controller: 'feedbacks', action: 'update'

  # DELETE
  delete 'users/:user_id/feedbacks/:id', controller: 'feedbacks', action: 'destroy'
  #------------------------------
